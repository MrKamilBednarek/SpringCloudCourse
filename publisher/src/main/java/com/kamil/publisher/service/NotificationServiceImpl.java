...
import com.kamil.publisher.model.Notification;
import com.kamil.publisher.model.Student;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    private static Notification createNotification(Student student) {
        ...
        notification.setBody("Milo, ze jestes z nami "+ student.getFirstName()+" "+ student.getLastName());
        return notification;
    }
}
